...
namespace CSAngband {
	class Score {
		...
		{
			return (Misc.p_ptr.max_exp + (100 * Misc.p_ptr.max_depth));
		}
		...
		// */
		//static int highscore_read(high_score scores[], size_t sz)
		//{
		//    char fname[1024];
		//    ang_file *scorefile;
		//    size_t i;
		 ...
		 */
		public static void predict_score()
		{
		...
		public static void show_scores()
		{
			...
			/* Display the scores */
			if (Player.Player.character_generated)
			{
				predict_score();
			}
			else
